...
​	此函数依据给定的上环半径/下环半径/间距绘制两均匀载流线圈构成的Helmholtz线圈的磁感应强度分布，并返回其图形句柄。

​	[$\color{green} 点此下载函数文件$](https://wang-guosheng.github.io/CompPhyExs/helmholtzfun.m)
